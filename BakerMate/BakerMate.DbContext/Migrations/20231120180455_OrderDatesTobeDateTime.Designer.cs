...
namespace BakerMate.DbContext.Migrations
{
    ...
    [Migration("20231120180455_OrderDatesTobeDateTime")]
    partial class OrderDatesTobeDateTime
    {
            ...
            modelBuilder.Entity("BakerMate.Domain.Model.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderingDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 11, 20, 20, 4, 55, 177, DateTimeKind.Local).AddTicks(8392));
