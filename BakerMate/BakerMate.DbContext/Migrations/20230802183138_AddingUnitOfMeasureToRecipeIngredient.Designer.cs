...
namespace BakerMate.DbContext.Migrations
{
    ...
    [Migration("20230802183138_AddingUnitOfMeasureToRecipeIngredient")]
    partial class AddingUnitOfMeasureToRecipeIngredient
    {
            ...
            modelBuilder.Entity("BakerMate.Domain.Model.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderingDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 8, 2, 21, 31, 38, 395, DateTimeKind.Local).AddTicks(2065));
